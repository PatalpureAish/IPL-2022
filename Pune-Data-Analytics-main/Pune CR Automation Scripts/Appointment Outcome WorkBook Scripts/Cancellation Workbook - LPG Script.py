...
data = pd.read_excel(r'C:\Users\prithwidip.das\Downloads\LPG.xlsx')
...
directory = r'C:\Users\prithwidip.das\Downloads\LPG Clients'
...
for unique_id, child_unique_id, name in zip(unique_ids_parent, unique_ids_child, client_name):
    ...
    if child_unique_id_str == '':
        ...
        sql_query_child_template = f"""SELECT
                                    ...
                                    --For LPGs, use one of the following fields--
                                    --AND e.parent_entity_id = 'XXX' --parent account
                                    --AND e.SALESFORCE_ULTIMATE_PARENT_ACCOUNT_ID like '%0016Q00001Z4dgVQAR%' 
                                    AND a.MONOLITH_PROVIDER_ID IN ({child_unique_id_str}) -- child account
