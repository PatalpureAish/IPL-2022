...
df=pd.read_sql(f"""
        ...
        where IS_CREATED_APPOINTMENT
          ...
          and e.SALESFORCE_ULTIMATE_PARENT_ACCOUNT_ID = '0016000000OUGToAAP'
        ...
        --    select * from provider_location_base;
           ...
           , resource_identification as
            ...
            (select distinct RESOURCE_ID
             ...
             where e.SALESFORCE_ULTIMATE_PARENT_ACCOUNT_ID = '0016000000OUGToAAP')
...
wb = xw.Book(r'C:\Users\Vinayak.Laxmeshwar\Desktop\SDG\SDG Resource Mapping Template.xlsx')
xw.sheets['SDG - Resource Mapping Summary'].range('A11').options(index=False).value = df

wb.save(r'C:\Users\Vinayak.Laxmeshwar\Desktop\SDG\SDG_Resource_Mapping- ' +ym +'.xlsx')
wb.close()
...
wb = openpyxl.load_workbook(r'C:\Users\Vinayak.Laxmeshwar\Desktop\SDG\SDG_Resource_Mapping- ' +ym +'.xlsx')
ws = wb['SDG - Resource Mapping Summary']
ws['C6'] =  res + ' - ' + last
