...
data = pd.read_excel(r'C:\Users\Vinayak.Laxmeshwar\Documents\Files\Review\Health_Review_file.xlsx')
...
for unique_id, child_unique_id, name in zip(unique_ids_parent, unique_ids_child, client_name):
    ...
    if child_unique_id_str == '':
        ...
        directory = r'C:\Users\Vinayak.Laxmeshwar\Documents\Health System Review Downloads'
...
subject = 'Health System Review Download- ' + Last_month + '.'
message = """Hi All,

The Health System Client Review Downloads has ran successfully.
